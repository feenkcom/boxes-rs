...
//     }
//
//     pub fn boxer_array_create() -> *mut ValueBox<ArrayBox<T>> {
//         ValueBox::new(ArrayBox::<T>::default()).into_raw()
//     }
//
//     pub fn boxer_array_create_with(element: T, amount: usize) -> *mut ValueBox<ArrayBox<T>> {
...
//         _data: *mut T,
//         amount: usize,
//     ) -> *mut ValueBox<ArrayBox<T>> {
//         ValueBox::new(ArrayBox::<T>::from_data(_data, amount)).into_raw()
//     }
//
//     pub fn boxer_array_drop(ptr: *mut ValueBox<ArrayBox<T>>) {
//         ptr.release();
//     }
//
...
//     }
//
//     pub fn boxer_array_get_length(_maybe_null_ptr: *mut ValueBox<ArrayBox<T>>) -> usize {
//         _maybe_null_ptr.with_not_null_return(0, |array| array.length)
//     }
//
//     pub fn boxer_array_get_capacity(_maybe_null_ptr: *mut ValueBox<ArrayBox<T>>) -> usize {
//         _maybe_null_ptr.with_not_null_return(0, |array| array.capacity)
//     }
//
//     pub fn boxer_array_get_data(_maybe_null_ptr: *mut ValueBox<ArrayBox<T>>) -> *mut T {
//         _maybe_null_ptr.with_not_null_return(std::ptr::null_mut(), |array| array.data)
//     }
//
//     pub fn boxer_array_at_put(_maybe_null_ptr: *mut ValueBox<ArrayBox<T>>, index: usize, item: T)
//     where
//         T: Clone,
//     {
...
//         _maybe_null_ptr: *mut ValueBox<ArrayBox<T>>,
//         index: usize,
//         default: T,
//     ) -> T
//     where
