...
#[no_mangle]
pub extern "C" fn boxer_array_u8_argb_to_rgba(array: *mut ValueBox<BoxerArrayU8>) {
    array
...
#[no_mangle]
pub extern "C" fn boxer_array_u8_bgra_to_argb(array: *mut ValueBox<BoxerArrayU8>) {
    array
        .with_mut_ok(|array| {
...
#[no_mangle]
pub extern "C" fn boxer_array_u8_rgba_to_argb(array: *mut ValueBox<BoxerArrayU8>) {
    array
        .with_mut_ok(|array| {
